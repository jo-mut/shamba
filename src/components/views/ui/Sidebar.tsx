...
const Sidebar = ({
    ...
    return (
        <nav className="sidebar shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
            ...
            <div className="mt-6">
                <h6 className="text-white text-sm font-bold px-4">Investing</h6>
                <ul className="mt-3">
                    {checkAdmin &&
                        <li>
                    ...
                    {!checkAdmin &&
                        <li>
                            <Link href={checkAdmin ? "/admin/investing" : "/home/statistics"}
                                className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="w-[18px] h-[18px] mr-4"
                                    viewBox="0 0 512 512">
                                    <path
                                ...
                                <span className='text-white'>{checkAdmin ? "Investing" : "Statistics"}</span>
                            </Link>
                        </li>}
                </ul>
            </div>
            ...
            <div className="mt-6">
                <h6 className="text-white text-sm font-bold px-4">Pools</h6>
                <ul className="mt-3">
                    <li>
                        <Link href={checkAdmin ? "/admin/pools/yields" : "/admin/pools/yields"}
                            className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="w-[18px] h-[18px] mr-4"
                            ...
                            <span className='text-white'>Yields Farming</span>
                        </Link>
                    </li>
                    <li>
                        <Link href={checkAdmin ? "/admin/pools/liquidity" : "/home/pools/liquidity"}
                            className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="w-[18px] h-[18px] mr-4"
                                viewBox="0 0 511.877 511.877">
                                <path
            ...
            <div className="mt-6">
                <h6 className="text-white text-sm font-bold px-4">Income</h6>
                <ul className="mt-3">

                    <li>
                        <Link href={checkAdmin ? "/admin/withdraw" : "/home/withdraw"}
                            className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="w-[18px] h-[18px] mr-4"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <li>
                        <Link href={checkAdmin ? "/admin/ico" : "/home/notifications"}
                            className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className="w-[18px] h-[18px] mr-4"
                            ...
                            <span className='text-white'>{checkAdmin ? "ICO Sale" : "Notifications"}</span>
                        </Link>
                    </li>
                </ul>
            </div>
