...
const Page = () => {
  ...
  useEffect(() => {
    if (address) {
      const loadToken = async () => {
        const token: any = await loadTokenICO();
  ...
  useEffect(() => {
    const calculatePercentage = () => {
      ...
      const tokenTotalSupply = tokenSold + Number(tokenDetails?.tokenBalance) * 1
              ...
              <h3 className="node__title node__title--red">
                ...
                <div className="progressbar progressbar--cta">
                  ...
                  <div className="progress"
                    ...
                    <span>
                      <div className="progressbar__value progressbar__value-left">
                        {Number(tokenDetails?.tokenBalance || 0) + Number(tokenDetails?.soldTokens || 0)}
                      </div>
                    </span>
                  </div>
                </div>
